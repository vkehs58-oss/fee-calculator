        ...
        {yearlySavings > 0 && (
          <div className="bg-green-50 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[14px] font-bold text-toss-green">절감 효과</span>
            </div>
            <p className="text-[13px] text-toss-gray-700">
              가장 비싼 플랫폼 대비 연간 <strong className="text-toss-green">{formatWon(yearlySavings)}</strong> 절약할 수 있어요.
              매달 <strong>{formatWon(savingsVsMax)}</strong>씩 아끼는 셈이에요.
            </p>
          </div>
        )}
